...
| Site                                                                             | Miss it and…                                                                                                                                                                                                              |
| -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cpp/PlainTextMeasurementHelpers.cpp` → `measurementInputsEqual`                 | the size goes stale after an update (hit in practice: `experiment` was missing here while it drove measurement, so toggling it alone never re-triggered `measureContent`, see [perf-experiments.md](perf-experiments.md)) |
