...
| `fontVariant`                                               |                                                                                                                                                                                                                                        |
| `fontVariationSettings`                                     | Variable-font axes in CSS syntax, e.g. `'"wght" 700, "wdth" 87.5'`. RN `<Text>` has no such style, so the style type is widened (`PlainTextStyle`). Needs a font with an `fvar` table (no system font qualifies), and Android API 26+. |
| `lineHeight`                                                |                                                                                                                                                                                                                                        |
| `letterSpacing`                                             |                                                                                                                                                                                                                                        |
| `textAlign`                                                 |                                                                                                                                                                                                                                        |
