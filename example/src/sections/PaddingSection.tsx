...
export function PaddingSection({ showText }: { showText: boolean }) {
  return (
    <Section title="Padding">
      <TextItem
        testID={featureCaptureTestID('padding', 'none')}
        label="none"
        showText={showText}
      ...
      <TextItem
        testID={featureCaptureTestID('padding', 'vertical-16')}
        label="vertical 16"
        showText={showText}
      ...
      <TextItem
        testID={featureCaptureTestID('padding', 'top-28-bottom-4')}
      ...
      <TextItem
        testID={featureCaptureTestID('padding', 'all-20-wrapped')}
