...
export function WrapDetectionSection({ showText }: { showText: boolean }) {
  return (
    <Section title="Wrap Detection">
      ...
      <TextItem
        testID={featureCaptureTestID('wrap-detection', 'control')}
        label="control"
        showText={showText}
      ...
      <TextItem
        testID={featureCaptureTestID('wrap-detection', 'hard-breaks')}
        label="hard breaks"
        showText={showText}
        style={styles.wrapProbe}
      >
      ...
      <TextItem
        testID={featureCaptureTestID('wrap-detection', 'longest-in-middle')}
      ...
      {/* Longest line last: same max-over-paragraphs check, position
        shouldn't matter. */}
      <TextItem
        testID={featureCaptureTestID('wrap-detection', 'longest-last')}
        label="longest last"
        showText={showText}
        style={styles.wrapProbe}
      >
      ...
      <TextItem
        testID={featureCaptureTestID('wrap-detection', 'soft-wrap-only')}
      ...
      <TextItem
        testID={featureCaptureTestID('wrap-detection', 'break-then-wrap')}
