  ...
  return (
    <Section title="Text Transform" footer={TEXT_TRANSFORM_FOOTER}>
      {TEXT_TRANSFORMS.map((textTransform) => (
        <TextItem
          key={textTransform}
          testID={featureCaptureTestID('text-transform', textTransform)}
          label={textTransform}
          showText={showText}
      ...
      <TextItem
        testID={featureCaptureTestID('text-transform', 'capitalize-digit-led-word')}
      ...
      <TextItem
        testID={featureCaptureTestID('text-transform', 'capitalize-contraction')}
