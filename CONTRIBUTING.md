...
| Capturing, comparing, or updating visual baselines                            | [visual-regression-testing.md](docs/contributing/visual-regression-testing.md): stages, baseline policy, reports, and environment checks      |
