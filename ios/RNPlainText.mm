...
// Once lineHeight, letterSpacing, a decoration, a shadow, writingDirection or lang is set, text/font/color/alignment must go through an NSAttributedString since UILabel has no plain properties for them.
